  ...
  <body>
    ...
    <h2>REGISTRAR GENERO</h2>
      <section class="formulario1">
        <form class="row g-3" action="genero" method="post">
          
          <div class="col-md-6">
            <label for="nombreGenero" class="form-label">Nombre genero</label>
            <input type="text" class="form-control" name="nombreGenero" id="nombreGenero">
          </div>
          <div>
            <label for="" class="form-label">Estado Genero</label> <br> <br>
